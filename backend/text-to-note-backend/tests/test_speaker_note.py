...
class TestSpeakerNote:
    ...
    def test_create_speaker_note(self, test_client):
    ...
    def test_create_multiple_speaker_notes(self, test_client):
    ...
    def test_create_speaker_note_missing_title(self, test_client):
    ...
    def test_create_speaker_note_empty_data(self, test_client):
    ...
    def test_get_all_speaker_notes(self, test_client):
    ...
    def test_get_empty_speaker_notes(self, test_client):
    ...
    def test_update_speaker_notes(self, test_client):
    ...
    def test_update_nonexistent_speaker_note(self, test_client):
    ...
    def test_delete_speaker_note(self, test_client):
    ...
    def test_delete_nonexistent_speaker_note(self, test_client):
    ...
    def test_delete_all_speaker_notes(self, test_client):
